...
使用方法:
  python3.8 beacon_login.py --cookie "key1=val1; key2=val2; ..." --output /path/to/auth_state.json
  python3.8 beacon_login.py --cookie-file /path/to/cookies.txt --output /path/to/auth_state.json
